...
#[no_mangle]
pub extern "C" fn pp_execute(json_ptr: *const c_char) -> *mut c_char {
    if json_ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn pp_free(ptr: *mut c_char) {
    if ptr.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "system" fn Java_plugins_NativeRustPlugin_ppExecuteJNI(
    mut env: JNIEnv,
    _class: JClass,
    request: JString,
) -> jstring {
