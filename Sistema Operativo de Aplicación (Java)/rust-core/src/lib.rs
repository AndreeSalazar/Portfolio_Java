...
#[no_mangle]
pub extern "C" fn os_execute(json_ptr: *const c_char) -> *mut c_char {
    if json_ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn os_free(ptr: *mut c_char) {
    if ptr.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "system" fn Java_os_OSRustAdapter_osExecuteJNI(
    mut env: JNIEnv,
    _class: JClass,
    request: JString,
) -> jstring {
